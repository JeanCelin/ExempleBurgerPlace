        ...
        <div className={style.missionContainer}>
          <div className={style.missionMessage}>
            ...
            <p className={style.textMessage}>
              ...
              aspire to be a destination where people feel welcomed, where every
              bite is an unforgettable experience. We are committed to providing
              delicious burgers made with fresh, quality ingredients while
              fostering a culture of exceptional service and social
              responsibility.
            </p>
          </div>
